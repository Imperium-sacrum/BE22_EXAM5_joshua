...
if (isset($_POST["login-btn"])) {
  ...
  if (!$error) {
    ...
    if (mysqli_num_rows($result) == 1) {
      ...
      $errorlog = "<div class='alert alert-danger'>
...
<body>
    ...
    <div class="container-fluid h-custom">
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-md-9 col-lg-6 col-xl-5">
          <img src="../images/pet store.jpg" class="img-fluid" alt="Sample image" />
        </div>
        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
          <form method="POST" method="<?php echo htmlspecialchars(($_SERVER['PHP_SELF'])) ?>">
            ...
            <div data-mdb-input-init class="form-outline mb-4">
              ...
              <p class="text-danger border border-danger text-center bg-warning"><?= $emailError ?></p>
            </div>
            ...
            <div data-mdb-input-init class="form-outline mb-3">
              ...
              <p class="text-danger border border-danger text-center bg-warning"><?= $passError ?></p>
            </div>
            ...
            <div class="text-center text-lg-start mt-4 pt-2">
              <button type="submit" name="login-btn" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem">
                Login
              </button>
  ...
  <div class="footer border border-black">
    <div class="d-flex flex-column flex-md-row text-center text-md-start justify-content-between py-4 px-4 px-xl-5 bg-primary">
      <!-- Copyright -->
      <div class="text-white mb-3 mb-md-0">
        Copyright © 2024. All rights reserved Rauchwerger .
      </div>
      <!-- Copyright -->
